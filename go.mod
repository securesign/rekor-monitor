...
require (
	...
	github.com/sigstore/rekor-tiles/v2 v2.2.2-0.20260427094043-999e74d5bafd
...
require (
	...
	github.com/theupdateframework/go-tuf/v2 v2.4.2-0.20260427141129-a5a1273fd033 // indirect
